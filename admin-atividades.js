...
if (mesInput && !mesInput.dataset.listener) {
  mesInput.dataset.listener = "1";
  mesInput.addEventListener("change", () => atualizarResumoAdmin());
}
...
// ✅ filtro por mês (input type="month" retorna "YYYY-MM")
if (mesSelecionado && a.mesRef !== mesSelecionado) return;
